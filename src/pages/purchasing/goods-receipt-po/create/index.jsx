import CCreateGoodsReceiptPO from "@/components/pages/CCreateGoodsReceiptPO";
import pick from "@/utils/pick"

const CreateGoodsReceiptPO = ({ initialData, messages }) => {
    return (
        <CCreateGoodsReceiptPO initialData={initialData} messages={messages} />
    )
}

CreateGoodsReceiptPO.messages = ['CreateGoodsReceiptPO', 'General', 'PageLayout', 'Navigation', 'Languages', 'Messages', 'Dialog'];
