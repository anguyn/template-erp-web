...
//                         // const vatGroupResult = await fetch('/api/company/get-vat-group', {
//                         //     method: 'GET',
//                         //     headers: {
//                         //         'Content-Type': 'application/json',
//                         //     },
//                         //     credentials: 'include'
//                         // });
//                         // console.log("VAT: ", vatGroupResult)
...
const Login = ({ messages }) => {
    return (
        <CLogin messages={messages} />
    )
};

Login.messages = ['General', 'Auth', 'PageLayout', 'Languages', 'Navigation'];
