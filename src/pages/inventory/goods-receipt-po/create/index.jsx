...
const CreateGoodsReceiptPO = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                const fetchVatGroups = async () => {
                    const queryProps = {
                        filter: ["Category eq 'bovcInputTax'"]
                    };
    ...
    const ItemTaxAmountTemplate = (product) => {
        return <div className="w-full p-inputtext p-component flex-1 !min-h-[42px]"><span className="h-[21px]">{product.TaxAmount && (formatNumberWithComma(product.TaxAmount) + ' ' + generalInfo?.DocCurrency?.Code)}</span></div>
            ;
    }

    const ItemGrossTotalTemplate = (product) => {
        return <div className="w-full p-inputtext p-component flex-1 !min-h-[42px]"><span className="h-[21px]">{product.GrossTotal && (formatNumberWithComma(product.GrossTotal) + ' ' + generalInfo?.DocCurrency?.Code)}</span></div>
            ;
    }
    ...
    // const contentServiceColumns = useMemo(
    //     () => [
    //         {
    //             header: 'Description',
    //             field: 'Description',
    //             className: 'text-center',
    //             minWidth: '12rem',
    //             body: ServiceDescriptionTemplate
    //         },
    //         {
    //             header: 'G/L Account',
    //             field: 'GLAccount',
    ...
    //             className: 'text-right',
    //             minWidth: '14rem',
    //             body: ServiceQuantityPriceTemplate
    //         },
    //         {
    //             header: 'Unit Price',
    //             field: 'UnitPrice',
    ...
    //             className: 'text-right',
    //             minWidth: '14rem',
    //             body: ServiceDiscountPercentTemplate
    //         },
    //         {
    //             header: 'Total After Discount',
    //             field: 'Total',
    //             className: 'text-right',
    //             minWidth: '14rem',
    //             body: ServiceTotalTemplate
    //         },
    //         {
    //             header: 'Tax Code',
    //             className: 'text-right',
    //             minWidth: '14rem',
    //             body: ServiceTaxCodeTemplate
    //         },
    //         {
    //             header: 'Tax Rate',
    //             className: 'text-right',
    //             minWidth: '14rem',
    //             body: ServiceTaxRateTemplate
    //         },
    //         {
    //             header: 'Tax Amount',
    //             className: 'text-right',
    //             minWidth: '14rem',
    //             body: ServiceTaxAmountTemplate
    //         },
    //         {
    //             header: 'UoM Code',
    //             field: 'UoMCode',
    ...
    //             className: 'text-right',
    //             minWidth: '14rem',
    //             body: ServiceGrossTotalTemplate
    //         },
    //         {
    //             header: 'System',
    //             field: 'U_System',
    ...
    //             className: 'text-center',
    //             minWidth: '14rem',
    //             body: ServiceActualDaysTemplate
    //         },
    //         {
    //             header: 'Standard Days',
    //             field: 'U_StandardDays',
    //             className: 'text-center',
    //             minWidth: '14rem',
    //             body: ServiceStandardDaysTemplate
    //         },
    //         {
    //             header: 'Grade',
    //             field: 'U_Grade',
    ...
    //             className: 'text-right',
    //             minWidth: '14rem',
    //             body: ServiceAPInvoiceENoTemplate
    //         },
    //         {
    ...
    //             className: 'text-right',
    //             minWidth: '14rem',
    //             body: ServiceActualDeliveryDateTemplate
    //         },
    //     ],
    //     [itemList, warehouseOptions, contentData]
    // );
        ...
        !loading ?
            (
                <div>
                            ...
                            <div className="card">
                                ...
                                <section>
                                    ...
                                    <div className="grid gap-4 grid-cols-1 sm:grid-cols-3 md:grid-cols-4 p-[7px]">
                                        <div className="flex flex-column gap-2">
                                            ...
                                            <div className="flex">
                                                <Dropdown loading={!dataLoaded} checkmark filter options={dataLoaded ? supplierListOptions : []} value={supplierListOptions.find(val => val.code == selectedSupplier?.CardCode)}
                                                    valueTemplate={SupplierDropdownValueTemplate} itemTemplate={SupplierDropdownItemTemplate}
                                                    optionLabel="name" placeholder={!dataLoaded ? "Loading supplier... " : "Select supplier"} onChange={(e) => handleChangeSelectedSupplier(e.value.code)} className="w-full" />
                                                <Button disabled={!dataLoaded} icon="pi pi-list" onClick={() => { setSupplierSelectModalOpen(true) }} />
                                            </div>
                                        </div>
                                        <div className="flex flex-column gap-2">
                                            <label className='font-semibold'>{t('supplierName')}</label>
                                            <div className="w-full p-inputtext p-component flex-1 !min-h-[42px]"><span className="h-[21px]">{selectedSupplier?.CardName || ""}</span></div>
                                        </div>
                                        <div className="flex flex-column gap-2">
                                        ...
                                        <div className="flex flex-column gap-2">
                                            ...
                                            <InputText aria-describedby="supplier-ref-no" />
                                        </div>
                                        <div className="flex flex-column gap-2">
                                ...
                                <section>
                                    ...
                                    <div className="mt-4">
                                        {dataLoaded ?
                                            (
                                                <BlockUI blocked={!selectedSupplier} template={<i className="pi pi-lock" style={{ fontSize: '3rem' }}></i>}>
                                                    <DataTable
                                                        ref={contentTableRef}
                                                        reorderableRows
                                                        value={contentData}
                    ...
                    />
                    <SupplierList supplierSelectModalOpen={supplierSelectModalOpen} setSupplierSelectModalOpen={(value) => setSupplierSelectModalOpen(value)} supplierList={supplierList} orignalSelectedSupplier={selectedSupplier} setSupplier={handleChangeSelectedSupplier} />
                    ...
                    <BatchSerialCreation batchSerialModalOpen={batchSerialModalOpen} item={selectedItemRow} setBatchSerialModalOpen={setBatchSerialModalOpen} setBatchCreations={handleBatchCreation} setSerialCreations={handleSerialCreation} />
...
CreateGoodsReceiptPO.messages = ['CreateGoodsReceiptPO', 'General'];
    ...
    return {
        props: {
            messages: pick(
                ...
                CreateGoodsReceiptPO.messages
            ),
        }
    };
}

export default withAuth(CreateGoodsReceiptPO);
